    ...
    <main class="bg-light">
        <div class="p-2">
            ...
            <nav class="px-3 py-2 bg-white rounded shadow">
                ...
                <?php include('admin_com_profile.php')?>
            </nav>
            <!-- end: Navbar -->
            ...
            <div class="d-flex justify-content-center">
                <div class="card border-0 shadow-sm mt-3 col-10">  
                    <div class="card-body">
                        ...
                        <hr>
                        <div class="d-flex justify-content-center">
                            <a href="teacher_regis_sv.php" class="fw-bold btn btn-secondary me-2">Back</a>
                            <a href="teacher.php" class="fw-bold btn btn-danger me-2">Close</a>
                            <a href="teacher_regis_sv3.php" class="fw-bold btn btn-primary">Next</a>
                        </div>
                    </div>
                </div>
            </div>
